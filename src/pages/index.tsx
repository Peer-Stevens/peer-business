	...
	return (
		...
		>
			...
			<p>
				...
				Made with Next.js, TypeScript, ESLint, Prettier, Husky, Lint-Staged, VSCode,
				Netlify, PostCSS, Tailwind CSS.
			</p>
			...
			<p>
				...
				<a href="https://github.com/ixartz/Next-js-Boilerplate">Nextjs Boilerplate</a>. You
				can also browse our{" "}
